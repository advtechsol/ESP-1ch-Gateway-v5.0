...
// Hardware profile selector for ESP32 targets.
// 0 = Generic ESP32 Dev Module using manual pin assignments.
// 1 = Heltec WiFi LoRa 32 relying on the Heltec helper library.
#define BOARD_PROFILE_GENERIC_ESP32 0
#define BOARD_PROFILE_HELTEC_WIFI_LORA 1

#if !defined(_BOARD_PROFILE)
#	define _BOARD_PROFILE BOARD_PROFILE_GENERIC_ESP32
#endif
...
//	5: ESP32 Dev Module wired to Heltec V2 pinout (manual pin mapping)
#if !defined _PIN_OUT
